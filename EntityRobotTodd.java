...
public class EntityRobotTodd extends EntityMob
{
	...
	public EntityRobotTodd(World world)
	{
		super(world);
		texnumber = 0;
        ...
        tasks.addTask(6, new EntityAIWatchClosest(this, EntityRobotTed.class, 8F));
        tasks.addTask(7, new EntityAILookIdle(this));
        targetTasks.addTask(1, new EntityAIHurtByTarget(this, false));
        targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 0, true));
        targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityRobotTed.class, 0, true));
	}
    ...
    public class AIAttackEntity extends EntityAIBase {
    	...
    	public EntityRobotTodd robot = EntityRobotTodd.this;
    ...
    public void onDeath(DamageSource damagesource)
    {
    	...
    	{
    		dropItem(MoreCreepsAndWeirdos.itemBattery, rand.nextInt(2) + 1);
    	}
